...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/hypothesize-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/hypothesize-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add hypothesize
# for installing globally
pixi global install hypothesize
```
...
It is possible to list all of the versions of `hypothesize` available on your platform:
...
```
pixi search hypothesize --channel conda-forge
```
